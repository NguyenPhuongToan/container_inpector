        ...
        children: [
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  _buildInfoRow('Số container', inspection.containerNumber),
                  const Divider(height: 1),
                  _buildInfoRow('Số serial flexitank', inspection.flexitankNumber),
                  const Divider(height: 1),
                  _buildInfoRow('Số booking', inspection.bookingNumber),
                  const Divider(height: 1),
                  _buildInfoRow('Số xe', inspection.truckNumber),
                  const Divider(height: 1),
                  _buildInfoRow('Nhân viên', inspection.workerName),
                  const Divider(height: 1),
                  _buildInfoRow('Cảng', inspection.portName),
                  const Divider(height: 1),
                  _buildInfoRow('Ngày', inspection.formattedDate),
                  if (inspection.notes.isNotEmpty) ...[
                    const Divider(height: 1),
                    _buildInfoRow('Ghi chú', inspection.notes),
                  ],
                ],
              ),
            ),
